                          ...
                          rows: List<DataRow>.generate(
                            ...
                            (index) => DataRow(
                              cells: [
                                ...
                                DataCell(
                                  Text(
                                      '${snapshot.data?.docs[index]['instructorId'] ?? ''}'),
                                ),
                                DataCell(
                                  Text(
                                      '${snapshot.data?.docs[index]['instructorPrefix']} ${snapshot.data?.docs[index]['instructorFirstName']} ${snapshot.data?.docs[index]['instructorLastName'] ?? ''}'),
                                ),
                                DataCell(
                                  Text(
                                      '${snapshot.data?.docs[index]['instructorId'] ?? ''}'),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      IconButton(
                                          ...
                                          onPressed: () {
                                            controller
                                                .updateInstructorIdTextEditingController
                                                .text = snapshot
                                                    .data?.docs[index]
                                                ['instructorId'];
                                            controller
                                                .updateInstructorFirstNameTextEditingController
                                                .text = snapshot
                                                    .data?.docs[index]
                                                ['instructorFirstName'];
                                            controller
                                                .updateInstructorLastNameTextEditingController
                                                .text = snapshot
                                                    .data?.docs[index]
                                                ['instructorLastName'];
                                            showDialog(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        if (controller
                                                                          ...
                                                                          controller.isUpdateLoading =
                                                                              true;
                                                                          await controller.updateInstructor(snapshot
                                                                              .data
                                                                              ?.docs[index]
                                                                              .id);
                                                                          controller
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        controller.isDeleteLoading =
                                                                            true;
                                                                        await controller.deleteInstructor(snapshot
                                                                            .data
                                                                            ?.docs[index]
                                                                            .id);
                                                                        Get.back();
